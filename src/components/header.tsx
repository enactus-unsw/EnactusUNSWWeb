  ...
  return (
    <header className="bg-white shadow-md px-10">
      <nav className="mx-auto flex  items-center justify-between ">
        ...
        <a href="/">
        <img className="h-16 block ml-auto mr-auto m-3" src={enactusLogo} alt="Enactus UNSW Logo" />
        </a>
        </div>
        <div className="flex align-self: flex-end space-x-16">
          ...
          <EnactusButton to="/#join-us"  rel="noopener noreferrer" className="bg-[#FFC222] text-black hover:scale-100 py-2 hover:bg-[#FFDD83]">
            JOIN US
          </EnactusButton>
        </div>
      </nav>
