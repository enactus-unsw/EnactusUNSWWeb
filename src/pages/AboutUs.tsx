  ...
  return (
    <div>
      <header className="text-center pt-20 md:pb-14">
        <h1 className="font-bold text-4xl sm:text-5xl mb-8">Welcome to Enactus UNSW!</h1>
        <h4 className="text-xl sm:text-2xl">Be the change you want to see <br /> in the world.</h4>
      </header>
      {/* Our story section */}
      <section>
      ...
      <section className="text-center flex flex-col justify-center items-center md:mt-16">
        <img src={enactusSDGLogo} alt="Enactus SDG Logo" className="mb-14 w-1/3 sm:w-1/2 max-w-xs"/>
