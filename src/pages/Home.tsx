  ...
  return (
    <>
      <header className="text-center">
        <img
          className="h-20 block ml-auto mr-auto m-4"
          src={enactusUNSWLogo}
      ...
      <section className="text-center pt-14 pb-20 pl-2 pr-2">
        <h1 className="font-bold text-2xl sm:text-3xl mb-12">Our Projects</h1>
        <Link to={"/projects"}>
          <HomeProjectCards />
        </Link>
      </section>
      ...
      <section className="bg-[#FFEBB6] pt-16 pb-10 text-center pl-2 pr-2">
        <h1 className="font-bold text-2xl sm:text-3xl mb-12">Our Events</h1>
      ...
      <section id="join-us" className="text-center pt-12 pb-20">
        <h1 className="font-bold text-2xl sm:text-3xl">How to get involved?</h1>
        <h3 className="font-bold text-lg pt-10 pb-4">Join Us on Rubric</h3>
        <EnactusButton
        ...
        <h3 className="font-bold text-lg pt-10 pb-4">Follow Our Socials</h3>
