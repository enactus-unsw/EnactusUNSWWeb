        ...
        >
          <div className="mb-6 flex gap-4">
            <div className="flex-1">
              <label className="block text-left text-lg font-semibold mb-2" htmlFor="firstName">
                First Name
              </label>
              <input
                id="firstName"
            ...
            <div className="flex-1">
              <label className="block text-left text-lg font-semibold mb-2" htmlFor="lastName">
                Last Name
              </label>
              <input
                id="lastName"
          ...
          {submitted ? (
            <div className="text-green-600 text-xl font-semibold mb-4">Thank you for contacting us! We'll get back to you soon.</div>
          ) : (
